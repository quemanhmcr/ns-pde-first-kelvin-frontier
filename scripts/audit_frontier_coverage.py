...
SEAMS = {
    ...
    "first-bad-codeforming-bias-collapse": ("open-literal", "no theorem forces the mean co-deforming finite-shape bias E chi to vanish on the actual migrating first-bad support"),
    "first-bad-codeforming-spread-collapse": ("open", "no uniform theorem controls co-deforming residual covariance/qv together with support conditioning and all moving physical faces near first bad time"),
...
if SEAMS["first-bad-codeforming-bias-collapse"][0] != "open-literal":
    raise SystemExit("first-bad co-deforming mean-bias collapse must remain open-literal")
if SEAMS["first-bad-codeforming-spread-collapse"][0] != "open":
    raise SystemExit("first-bad co-deforming spread collapse must remain open")
