...
SEAMS = {
    ...
    "first-bad-full-shape-local-descent": ("open-literal", "exact cubic/Legendre NS calibrations forbid finite-scale D/area/finite-moment closure; a theorem that genuinely shrinking first-bad support makes the full current shape descend to the local joint block is still missing"),
