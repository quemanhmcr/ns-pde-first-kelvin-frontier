...
SEAMS = {
    ...
    "first-bad-selected-hybrid-path-instantiation": ("open-literal", "the hybrid law is exact once library and selector path are supplied, but NS badness/resolve timing and simultaneous physical event maps are not instantiated"),
