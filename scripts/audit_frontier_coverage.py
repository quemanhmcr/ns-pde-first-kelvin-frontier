...
SEAMS = {
    ...
    "selected-support-cauchy-deformation-alignment": ("open-literal", "the frozen local fiber coupling is now exact, but the programme-specific full finite-current lift, replica-dependent selector evolution, and actual Kelvin cochain sampled along stochastic shape remain unresolved"),
