...
SEAMS = {
    ...
    "first-bad-persistent-library-dynamics": ("open-literal", "the selector/readout algebra is exact but the NS-generated persistent candidate-library dynamics and programme-specific admissible relations are not defined line by line"),
...
if SEAMS["first-bad-persistent-library-dynamics"][0] != "open-literal":
    raise SystemExit("persistent first-bad candidate-library dynamics must remain open-literal until generated by NS/programme definitions")
