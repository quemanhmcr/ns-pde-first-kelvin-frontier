...
for seam in ("cross-event-principal-axis-lineage", "first-bad-orientation-packet-refinement-instantiation", "first-bad-selected-spectral-lineage"):
    if SEAMS[seam][0] != "open-literal":
        raise SystemExit(f"{seam} must remain open-literal until the missing programme-specific physical map is supplied")
